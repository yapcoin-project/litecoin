...
#if defined(NDEBUG)
# error "Yapcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Yapcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s YAP additional fees, %d delta bytes\n",
