...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s yapcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  yapcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded yapcoin transaction") + "\n" +
              "  yapcoin-tx [options] -create [commands]   " + _("Create hex-encoded yapcoin transaction") + "\n" +
              "\n";
