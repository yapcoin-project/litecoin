...
<context>
    ...
    <message>
        ...
        <translation>Это ваши адреса Yapcoin для отправки платежей. Всегда проверяйте сумму и адрес получателя перед отправкой перевода.</translation>
    </message>
    <message>
        ...
        <translation>Это ваши адреса Yapcoin для приёма платежей. Рекомендуется использовать новый адрес получения для каждой транзакции.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отправить монеты на указанный адрес Yapcoin</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписать сообщения вашим адресом Yapcoin, чтобы доказать, что вы им владеете</translation>
    </message>
    <message>
        <source>Verify messages to ensure they were signed with specified Yapcoin addresses</source>
        <translation>Проверить сообщения, чтобы удостовериться, что они были подписаны определённым адресом Yapcoin</translation>
    </message>
    <message>
        <source>&amp;File</source>
    ...
    <message>
        ...
        <translation>Запросить платежи (создаёт QR-коды и yapcoin: ссылки)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Открыть yapcoin: URI или запрос платежа</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n активных соединений с сетью Yapcoin</numerusform><numerusform>%n активных соединений с сетью Yapcoin</numerusform><numerusform>%n активных соединений с сетью Yapcoin</numerusform><numerusform>%n активных соединений с сетью Yapcoin</numerusform></translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Произошла неисправимая ошибка. Yapcoin не может безопасно продолжать работу и будет закрыт.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Введённый адрес "%1" не является правильным Yapcoin-адресом.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для Yapcoin-клиента на роутере. Работает только если Ваш роутер поддерживает UPnP, и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети Yapcoin через прокси SOCKS5</translation>
    </message>
    <message>
        <source>&amp;Connect through SOCKS5 proxy (default proxy):</source>
        <translation>&amp;Подключаться к сети Yapcoin через прокси SOCKS5 (прокси по умолчанию):</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети Yapcoin через прокси SOCKS5 для скрытых сервисов Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш бумажник автоматически синхронизируется с сетью Yapcoin после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить yapcoin: обработчик click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось обработать URI! Это может быть связано с неверным адресом Yapcoin или неправильными параметрами URI.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введите адрес Yapcoin (например, %1)</translation>
    </message>
    <message>
        <source>%1 d</source>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Заметьте: сообщение не будет отправлено вместе с платежом через сеть Yapcoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Внимание: неверный адрес Yapcoin</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес Yapcoin, на который отправить платёж</translation>
    </message>
    <message>
        <source>Alt+A</source>
    ...
    <message>
        ...
        <translation>К yapcoin: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией для вашего сведения. Заметьте: сообщение не будет отправлено через сеть Yapcoin.</translation>
    </message>
    <message>
        <source>Pay To:</source>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес Yapcoin, которым подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выберите ранее использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение адресом Yapcoin</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;Сообщение</translation>
    ...
    <message>
        ...
        <translation>Адрес Yapcoin, которым было подписано сообщение</translation>
    </message>
    <message>
        <source>Verify the message to ensure it was signed with the specified Yapcoin address</source>
        <translation>Проверить сообщение, чтобы убедиться, что оно было подписано указанным адресом Yapcoin</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Проверить &amp;Сообщение</translation>
