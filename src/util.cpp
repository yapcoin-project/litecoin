...
const char * const BITCOIN_CONF_FILENAME = "yapcoin.conf";
const char * const BITCOIN_PID_FILENAME = "yapcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Yapcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Yapcoin";
#else
    // Unix
    return pathRet / ".yapcoin";
#endif
#endif
}
