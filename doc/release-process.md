...
space *do not upload these to the yapcoin.co server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the yapcoin.co server.

```

- Update yapcoin.co version

- Announce the release:

  - yapcoin-dev and yapcoin-dev mailing list

  - blog.yapcoin.co blog post
